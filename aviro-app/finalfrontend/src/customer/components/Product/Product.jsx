             ...
             <form className="hidden lg:block">
                      ...
                      <>
                        <h3 className="-my-3 flow-root">
                          <Disclosure.Button className="flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500">
                            ...
                            <FormLabel sx={{color:"black"}} className='text-grey-900' id="demo-radio-buttons-group-label]">{section.name}</FormLabel>
                            <span className="ml-6 flex items-center">
                              {open ? (
                                <MinusIcon className="h-5 w-5" aria-hidden="true" />
                              ) : (
              ...
              <div className="lg:col-span-4 w-full">
                <div className='flex flex-wrap justify-center bg-white py-5'>
                    {solar_panels.map((item)=><ProductCard product={item}/>)}
                </div>
                <div className='flex flex-wrap justify-center bg-white py-5'>
                    {solar_inverters.map((item)=><ProductCard product={item}/>)}
                </div>
                <div className='flex flex-wrap justify-center bg-white py-5'>
                    {lithium_batteries.map((item)=><ProductCard product={item}/>)}
                </div>
